...
lb = [ 350e-9 350e-9 350e-9 350e-9 350e-9 18e-8  18e-8 18e-8 18e-8 18e-8 0.7];         %0.5 0.5 0.5];
ub = [ 35e-6 35e-6  35e-6 35e-6  35e-6  18e-6 18e-6 18e-6 18e-6 18e-6 0.7];        %1 1 1];
...
%                                           V,M 
res = myGA(@(x) interfaceEldo('circuit3',x),11,2,lb,ub);
